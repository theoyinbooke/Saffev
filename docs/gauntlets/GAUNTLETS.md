...
**Then build:** adapters for **Gemini CLI, Copilot CLI (`~/.copilot/otel`),
Windsurf, Amp, Goose** (priority order — by install base). Format-drift tolerance
rules as today: unparseable records skip, never fatal.
